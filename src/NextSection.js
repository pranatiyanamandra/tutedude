...
const NextSection = () => {
    return <>
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 next-text">
                What's Next?
                <br />
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <svg width="32" height="32" viewBox="0 0 32 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="next-icons">
            ...
            <div class="col-md-4 col-sm-6">
                ...
                Using your REFERRAL CODE in the <br />Payments page
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <svg width="32" height="32" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="next-icons">
                    <path d="M24 20V21.3333C24 22.8 22.8 24 21.3333 24H2.66667C1.18667 24 0 22.8 0 21.3333V2.66667C0 1.2 1.18667 0 2.66667 0H21.3333C22.8 0 24 1.2 24 2.66667V4H12C10.52 4 9.33333 5.2 9.33333 6.66667V17.3333C9.33333 18.8 10.52 20 12 20H24ZM12 17.3333H25.3333V6.66667H12V17.3333ZM17.3333 14C16.2267 14 15.3333 13.1067 15.3333 12C15.3333 10.8933 16.2267 10 17.3333 10C18.44 10 19.3333 10.8933 19.3333 12C19.3333 13.1067 18.44 14 17.3333 14Z" fill="url(#paint0_linear_3821_13691)" />
                    <defs>
                        <linearGradient id="paint0_linear_3821_13691" x1="25.3333" y1="12" x2="1.35156e-07" y2="12" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#800080" />
                            <stop offset="1" stop-color="#FF864C" />
                        </linearGradient>
                    </defs>
                ...
                <b>
                    You get Rs. 200 as referral money
                </b>
                <br />

                On total purchase the friend  <br />makes, into your wallet
                <br />
            </div>
            <div class="col-md-4 col-sm-6">
                <svg width="32" height="32" viewBox="0 0 19 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="next-icons">
                ...
                <b>
                    Your friend gets Rs. 200 off
                </b>
                <br />

                On his overall fee on successful  <br />purchase using your referral code
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <svg width="32" height="32" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="next-icons">
                    <path d="M26.547 13.4403L14.547 1.44033C14.067 0.960325 13.4003 0.666992 12.667 0.666992H3.33366C1.86699 0.666992 0.666992 1.86699 0.666992 3.33366V12.667C0.666992 13.4003 0.960325 14.067 1.45366 14.5603L13.4537 26.5603C13.9337 27.0403 14.6003 27.3337 15.3337 27.3337C16.067 27.3337 16.7337 27.0403 17.2137 26.547L26.547 17.2137C27.0403 16.7337 27.3337 16.067 27.3337 15.3337C27.3337 14.6003 27.027 13.9203 26.547 13.4403ZM5.33366 7.33366C4.22699 7.33366 3.33366 6.44033 3.33366 5.33366C3.33366 4.22699 4.22699 3.33366 5.33366 3.33366C6.44033 3.33366 7.33366 4.22699 7.33366 5.33366C7.33366 6.44033 6.44033 7.33366 5.33366 7.33366Z" fill="url(#paint0_linear_3821_13694)" />
                    <defs>
                        <linearGradient id="paint0_linear_3821_13694" x1="27.3337" y1="14.0003" x2="0.666992" y2="14.0003" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#800080" />
                            <stop offset="1" stop-color="#FF864C" />
                        </linearGradient>
                    </defs>
                ...
                When the wallet balance reaches  <br />Rs. 200 or more you can withdraw it
                <br />
            </div>
        </div>
        <div class="row">
...
<div class="col-md-4 col-sm-6">
    <br></br>
    <Link to="/friends-enrolled" className="referral">Friends Enrolled</Link>
</div>
...
<div class="col-md-4 col-sm-6 referral">
    <br></br>
    <Link to="/terms&conditions" className="referral">Terms & Conditons</Link>
</div>
